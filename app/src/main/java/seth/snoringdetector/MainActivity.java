 ...
 */
    ...
    public void setLevel(int l) {
        switch (l) {
            case 0:
                AlarmStaticVariable.level = AlarmStaticVariable.level0;
                break;
            case 1:
                AlarmStaticVariable.level = AlarmStaticVariable.level1;
                break;
            case 2:
                AlarmStaticVariable.level = AlarmStaticVariable.level2;
                break;
            case 3:
                AlarmStaticVariable.level = AlarmStaticVariable.level3;
                break;
            default:
                AlarmStaticVariable.level = AlarmStaticVariable.level1;
                break;
